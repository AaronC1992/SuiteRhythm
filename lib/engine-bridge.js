'use client';
/**
 * Engine Bridge — lightweight React ↔ SuiteRhythm integration layer.
 *
 * Provides:
...
const SYNC_CHANNEL = 'suiterhythm-sync';
 ...
 *   engine  – raw SuiteRhythm instance (may be null during load)
...
function applyAction(engine, action) {
  ...
  switch (type) {
    ...
    case 'stopAll':
      ...
      break;
    case 'recordSoundFeedback':
      engine.recordSoundFeedback?.(action?.payload || {});
      break;
    default:
      break;
  }
