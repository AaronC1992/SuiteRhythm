...
export const MODE_RULES = {
  ...
  * When a clear song end is detected (context mentions "applause", "end of song", "thank you", or sustained silence), you may return null music to let the track fade out.`,
    auto: '- Auto: strict accuracy. Prefer silence unless the transcript clearly names a current sound/action. Ambient context only when the setting/weather is explicit and confident. ONE-OFF actions only when mentioned.'
};
