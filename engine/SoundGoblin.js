...
class SoundGoblin {
    ...
    getStoryCueCategory(word) {
        const categories = {
            combat:      ['sword','swords','arrow','arrows','shield','strike','clashed','clash','cannon','cannons','shouted','dagger','knife','blade','axe','chopped','hacked','whip','brawl','pierced','impaled','shielded','gunshot','revolver','pistol','laser','blaster','armor','armored'],
            weather:     ['wind','howled','rain','storm','thunder','thundering','lightning','blizzard','snowstorm','avalanche','sandstorm','waterfall','foghorn','snapped'],
            fire:        ['fire','crackled','flames','flame','embers','candle','candles','match','torch','torches','extinguished','campfire','fireplace','hearth','bonfire','wildfire','inferno','lighter','zippo','kindled','kindle','lamp','lantern'],
            creature:    ['dragon','growl','wolf','owl','hooted','rat','horse','horses','goblin','goblins','snake','serpent','viper','bat','bats','vampire','bear','eagle','hawk','wolves','raven','crow','crows','pig','neigh','neighing','alien','demon','demonic'],
            movement:    ['footsteps','step','steps','crept','door','creaked','knocked','knock','boards','slammed','portcullis','gate','lever','drawbridge','trap','trapped','lockpick','lock','passage','spurs'],
            magic:       ['magic','spell','wizard','arcane','crystal','healing','chanted','incantation','portal','rift','fizzled','dispelled','counterspell','frost','frozen','ice','vanished','disappeared','invisible','gust','summoning','summoned','rune','runes','brew','brewing','cauldron'],
            water:       ['dripped','waves','waterfall','underwater','submerged','sewer','sewers','swamp','marsh'],
            celebration: ['bell','bells','music','celebrated','clock','midnight','crowd','applause','clapping','chimed','coach','victory','triumph','discovered','revealed','treasure','chest','gasp','gasped','holy','divine','sacred'],
            nautical:    ['ship','sailed','anchor','foghorn','harbor'],
            atmosphere:  ['shadow','shadows','whispered','heartbeat','silence','tavern','inn','jungle','cathedral','church','graveyard','cemetery','saloon','cave','cavern','library','market','marketplace','spaceship','spacecraft','funeral','mourning','gallows','hanged','execution','prayer','prayed','forest','woods','woodland','mountain','dungeon','village','winter','snow','desert','feast','banquet','monastery','breeze'],
            impact:      ['glass','shattered','exploded','trembled','collapsed','earthquake','avalanche','bones','skeleton','brawl','mob','riot'],
            vocal:       ['scream','screamed','shrieked','shriek','screeched','wailed','wail','sobbed','whimpered','bellowed','yelled','roared','gasp','gasped','laughed','cackled','cackling','cackle','grunted','groaned','dying','baby','infant','cried'],
            occult:      ['demon','demonic','ritual','cult','possessed','blood','undead','zombie','chains','shackled','prison','summoning','summoned','curse','cursed','hex'],
            dungeon:     ['trap','trapped','portcullis','gate','lever','drawbridge','lockpick','lock','cave','cavern','sewer','sewers','chains','prison','gallows'],
